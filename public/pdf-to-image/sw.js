...
const CACHE_NAME = 'pdf-to-image-v1';
const RUNTIME_CACHE = 'pdf-to-image-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/pdf-to-image/',
  '/pdf-to-image/manifest.json',
  '/pdf-to-image/icon-192.png',
  '/pdf-to-image/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/pdf-to-image/manifest.json';
}
